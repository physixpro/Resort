...
const SimpleCard = () => {
 ...
 {/***************** Second Card ******************/}
{showCardTwo ? (
      <Card data-aos-duration="3000" data-aos="fade-up" onMouseOver={() => setShowCardTwo(false)} className={classes.root} variant="outlined">
        <img
 ...
 {/***************** Third Card ******************/}
 {showCardThree ? (
      <Card data-aos-duration="1000" data-aos="fade-up" onMouseOver={ () => setShowCardThree(false)} className={classes.root} variant="outlined">
        <img 
